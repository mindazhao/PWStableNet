...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64):
        ...
        self.down2 = down(ngf * 2//2, ngf * 4//2)
        self.down3 = down(ngf * 4//2, ngf * 8//2)
        self.down4 = down(ngf * 8//2, ngf * 8//2)
        self.down5 = down(ngf * 8//2, ngf * 8//2)
        self.down6 = down(ngf * 8//2, ngf * 8//2)
        self.down7 = down(ngf * 8//2, ngf * 8//2)

        self.up7 = up(ngf * 8//2, ngf * 8//2)
        self.up6 = up(ngf * 16//2, ngf * 8//2)
        self.up5 = up(ngf * 16//2, ngf * 8//2)
        self.up4 = up(ngf * 16//2, ngf * 8//2)
        self.up3 = up(ngf * 16//2, ngf * 4//2)
        self.up2 = up(ngf * 8//2, ngf * 2//2)
        self.up1 = up(ngf * 4//2, ngf * 1, out=True)
        self.out = down(input_nc=ngf, output_nc=output_nc, kernal_size=3, stride=1, padding=1, out=True)

        self.down_bottom1 = down_bottom(ngf, ngf * 2//2, left_input=False)
        self.down_bottom2 = down_bottom(ngf * 2//2, ngf * 4//2)
        self.down_bottom3 = down_bottom(ngf * 4//2, ngf * 8//2)
        self.down_bottom4 = down_bottom(ngf * 8//2, ngf * 8//2)
        self.down_bottom5 = down_bottom(ngf * 8//2, ngf * 8//2)
        self.down_bottom6 = down_bottom(ngf * 8//2, ngf * 8//2)
        self.down_bottom7 = down_bottom(ngf * 8//2, ngf * 8//2)

        # x_up juanji,,,  shangcaiyang shuchu ,,,,,  he up jiazai yiqi shangcaiyangshuru

        self.up_bottom7 = up_bottom(ngf * 8//2, ngf * 8//2, ngf * 16//2)
        self.up_bottom6 = up_bottom(ngf * 16//2, ngf * 8//2, ngf * 32//2)
        self.up_bottom5 = up_bottom(ngf * 16//2, ngf * 8//2, ngf * 32//2)
        self.up_bottom4 = up_bottom(ngf * 16//2, ngf * 8//2, ngf * 32//2)
        self.up_bottom3 = up_bottom(ngf * 16//2, ngf * 4//2, ngf * 32//2)
    ...
    def forward(self, input1,is_training=True):
        ...
        if is_training:
            ...
            x_second = nn.Tanh()(self.out(x211))
        #####################
