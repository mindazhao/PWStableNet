...
parser.add_argument('--lr', type=float, default=0.01, help='Learning Rate. Default=0.002')
...
parser.add_argument('--start_loss_affine', type=int, default=40, help='epoch of starting loss_affine')
